...
export default function FeaturesPage() {
  ...
  return <PageTransition>
    ...
    <section className="section"><div className="container"><FeatureStories full /></div></section>
    ...
    <section className="section gallery-section"><div className="container"><ScreenshotGallery /></div></section>
